package site.teamo.biu.infinity.fweb.common.aspect;
...
public class ValidationAspect {
    ...
    @Around("@annotation(site.teamo.biu.infinity.fweb.common.annoation.Validation)")
    ...
    private BiuJSONResult error(Set<ConstraintViolation<Object>> constraintViolations, ProceedingJoinPoint pjp) {
        ...
        return BiuJSONResult.error(ErrorCode.PARAMETER.BAD_PARAMETER.code, result);
    }
}
