<template>
  <d2-container>
    ...
    <el-row :gutter="20">
      <el-col :span="6">
        <el-card class="box-card" header="总存储" shadow="always">
          {{ hdfs.total/1024.0/1024.0 }}MB
        </el-card>
      </el-col>
      <el-col :span="6">
        <el-card class="box-card" header="已用存储" shadow="always">
          <div class="text item">
            {{ hdfs.dfsUsed/1024.0/1024.0}}MB
          </div>
        </el-card>
      </el-col>
      <el-col :span="6">
    ...
    <el-row style="margin-top:15px">
      <el-card header="存储资源变化曲线" shadow="always">
        <template>
    ...
    data() {
      return {
        chartSettings: {
          ...
          metrics: ['totalFiles', 'totalBlocks']
        },
        chartData: {
          ...
          rows: [
            {
              ...
              'totalBlocks': 100000,
              'totalFiles': 200,
              'liveDataNodeNums': 1000,
              'deadDataNodeNums': 0,
              'missingBlocks': 0,
              'volumeFailuresTotal': '0',
              'createTime': '2020-01-20 10:20:20'
            },
            {
              'total': 100,
              'dfsUsed': 51,
              ...
              'missingBlocks': 0,
              'volumeFailuresTotal': '0',
              'createTime': '2020-01-21 10:20:20'
            },
            {
              'total': 100,
              'dfsUsed': 55,
              ...
              'missingBlocks': 0,
              'volumeFailuresTotal': '0',
              'createTime': '2020-01-22 10:20:20'
            },
            {
              'total': 100,
              'dfsUsed': 60,
              ...
              'missingBlocks': 0,
              'volumeFailuresTotal': '0',
              'createTime': '2020-01-23 10:20:20'
            },
            {
              'total': 100,
              'dfsUsed': 71,
              ...
              'missingBlocks': 0,
              'volumeFailuresTotal': '0',
              'createTime': '2020-01-24 10:20:20'
            },
            {
              'total': 100,
              'dfsUsed': 80,
